...
class Atri:
	...
	@property
	def atr(self):
		self._getter_access_tracker["atr"] = {}
		return self._atr
	@atr.setter
	def atr(self, new_state):
		self._setter_access_tracker["atr"] = {}
		global default_state
		self._atr = Image(new_state, default_state["atr"])

	@property
	def btn1(self):
		self._getter_access_tracker["btn1"] = {}
		return self._btn1
	@btn1.setter
	def btn1(self, new_state):
		self._setter_access_tracker["btn1"] = {}
		global default_state
		self._btn1 = Button(new_state, default_state["btn1"])
